...
function moveBox() {
  ...
  var box_1_class = box_1.getAttribute('class').replace('box box-1 col-1', '');
  var box_2_class = box_2.getAttribute('class').replace('box box-2 col-1', '');
  var box_3_class = box_3.getAttribute('class').replace('box box-3 col-1', '');
  var box_4_class = box_4.getAttribute('class').replace('box box-4 col-1', '');
  var box_5_class = box_5.getAttribute('class').replace('box box-5 col-1', '');
  var box_6_class = box_6.getAttribute('class').replace('box box-6 col-1', '');
  var box_7_class = box_7.getAttribute('class').replace('box box-7 col-1', '');
  var box_8_class = box_8.getAttribute('class').replace('box box-8 col-1', '');
  ...
  var box_8_pre_assigned_class = 'box box-8 col-1';
    ...
    if ( box_1_class === 'c2', 'r2' ) {
      ...
      box_1.setAttribute('class', 'box box-1 col-1' + box_1_class_replace);
      console.log(box_1);
